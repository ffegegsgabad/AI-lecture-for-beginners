      ...
      <div className="max-w-5xl w-full space-y-12">
        <div className="p-10 bg-card border-l-8 border-primary rounded-lg space-y-6">
          ...
          <p className="text-2xl text-muted-foreground font-medium">
            Para Pesquisa com Fontes
          </p>
          
          <p className="text-xl lg:text-2xl text-foreground leading-relaxed">
            "Google com ChatGPT" - resposta resumida + fontes verificáveis
          </p>
        </div>
        ...
        <div className="rounded-lg overflow-hidden shadow-lg">
          ...
          >
            <source src="/videos/perplexity-demo.mp4" type="video/mp4" />
          </video>
        </div>
      </div>
    </div>
